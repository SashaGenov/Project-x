...
//a := (math.Pow((meanSpeed(action, duration)/3.6), 2)/(height/100.0))
//b:= walkingCaloriesWeightMultiplier*weight
//c := a*walkingSpeedHeightMultiplier*weight * duration * minInH
//d:= b+c
